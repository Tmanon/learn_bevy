...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__h147e5eb9e6c75034: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__hd37e411730b0b295: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h5365a15f5f8563b8: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h3060a6f3093c84ea: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h1b334183322db2ea: (a: number, b: number, c: number) => void;
